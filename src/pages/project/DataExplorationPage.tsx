...
type ColKind = 'numeric' | 'categorical' | 'text' | 'datetime' | 'unknown';
...
const KIND_COLORS: Record<ColKind, string> = {
...
function KindIcon({ kind }: { kind: ColKind }) {
...
function kindLabel(k: ColKind): string {
...
function QualityBadge({ missing, total }: { missing: number; total: number }) {
...
// ─────────────────────────────────────────────────────────────────────────────
// Sub-component: Column detail panel (slides in on the right)
// ─────────────────────────────────────────────────────────────────────────────
